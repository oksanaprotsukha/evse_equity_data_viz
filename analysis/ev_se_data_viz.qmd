...
source(file.path(here::here('src', 'prep.R')))
```
...
### Data design process and decisions
...
**Dataset 2**. Climate and Economic Justice Screening Tool.\ 
...
For this infographic I used transportation categories, as well as the community's status as disadvantaged or not. Overview and metadata details:
...
**Dataset 2**. Alternative Fuels Data Center: Electric Vehicle Charging Station Locations.\ 
...
The infographic aims to answer the question **"Is our EV charging infrastructure equitable?"**.
To address the main question I analysed the following questions:
...
I utilized the following design approach to visualize the questions above.
...
**Question 2**: A dumbbell plot was selected for its effectiveness in comparing two values measured in the same units. It offers a compact layout and ease of interpretation, which made it a preferred choice for visualizing the second question.\
...
10. Applying a DEI lens to your design (e.g. considering the people / communities / places represented in your data, consider how you frame your questions / issue). My infographic was focused on identifying a bias in deployment of EV charging infrastructure with respect to disadvantaged communities. I attempted to maintain an objective tone in both my visuals and text. Specifically, I used a federally sponsored data set "Climate and Economic Screening Tool" to identify disadvantaged communities.
...
ev_state_pct_icon <- here::here("assets/ev_green_icon.png")
ev_dac_pct_icon <- here::here("assets/ev_orange_icon.png")
...
# export dumbell plot
ggsave(file = here("assets", "dumbell_p_bg.png"), plot = dumbell_p)
...
```{r , choropleth-display, fig.width=12, fig.height=8, out.width="80%", out.height="100%"}
#| code-fold: true
...
ggsave(file = here("assets", "choropleth_p.png"), plot = choropleth_p)
